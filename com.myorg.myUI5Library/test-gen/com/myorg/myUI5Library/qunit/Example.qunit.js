/*global QUnit */
sap.ui.define(["sap/ui/qunit/QUnitUtils", "sap/ui/qunit/utils/createAndAppendDiv", "com/myorg/myUI5Library/library", "com/myorg/myUI5Library/Example"], function (qutils, createAndAppendDiv, library, Example) {
  "use strict"; // refer to library types

  var ExampleColor = library.ExampleColor; // prepare DOM

  createAndAppendDiv("uiArea1"); // module for basic checks

  QUnit.module("Example Tests"); // example sync test
  ...
  QUnit.module("Basic Control Checks"); // some basic control checks
